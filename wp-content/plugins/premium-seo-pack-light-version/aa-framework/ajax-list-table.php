	...
	class pspAjaxListTable {
	    ...
	    */
		public function get_items()
		{
			...
			if ( $_SESSION['pspListTable'][$this->opt['id']]['id'] == 'pspSmushit' ) { // smushit
		...
		private function get_list_postTypes()
		{
			...
			return array_merge($_builtin, $_notBuiltin);
		}
		...
		public function print_header()
		{
			...
			if( trim($this->opt["custom_table"]) == ""){
				...
				if ( $_SESSION['pspListTable'][$this->opt['id']]['id'] != 'pspSmushit' ) { // if NOT smushit
