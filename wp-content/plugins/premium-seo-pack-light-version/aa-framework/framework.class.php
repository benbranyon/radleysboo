...
if(class_exists('psp') != true) {
	class psp {
		...
		function __construct($here = __FILE__)
		{
			...
			if ( isset($optimizeSettings['charset']) && !empty($optimizeSettings['charset']) ) $this->charset = $optimizeSettings['charset'];
			...
			if( is_admin() && $is_installed === false ) {
		...
		*/
		...
		public function admin_load_styles()
		{
			...
			wp_enqueue_style( 'psp-aa-framework-styles', $this->cfg['paths']['freamwork_dir_url'] . 'load-styles.php' );
