 ...
 echo json_encode(
	array(
		'Google_Analytics' => array(
			...
			'description' => "We’ve made a module that takes the data from Google Analytics and transforms it into a easy to understand dashboard, that will allow you to see the impact on search engines.",
