    ...
    class pspOnPageOptimization
    {
        ...
        */
        ...
        public function custom_col_head( $columns ) {
		    ...
		    $new_columns['psp_seo_score'] 		= __('SEO Score ', $this->the_plugin->localizationName);
			$new_columns['psp_seo_title'] 		= __('SEO Title', $this->the_plugin->localizationName);
		    $new_columns['psp_seo_fkw'] 		= __('SEO Focus KW', $this->the_plugin->localizationName);
        ...
        public function custom_col_sort_select()
        {
			...
			$html[] = '<option value="all">' . __( "Premium SEO Pack: All Scores", $this->the_plugin->localizationName ) . '</option>';
			$values = array(
				'none'      	=> __( 'Premium SEO Pack: No Score', $this->the_plugin->localizationName ),
				'bad'     		=> __( 'Premium SEO Pack: Bad', $this->the_plugin->localizationName ),
				'poor'    		=> __( 'Premium SEO Pack: Poor', $this->the_plugin->localizationName ),
				'ok'      		=> __( 'Premium SEO Pack: Ok', $this->the_plugin->localizationName ),
				'good'    		=> __( 'Premium SEO Pack: Good', $this->the_plugin->localizationName ),
				'excellent'		=> __( 'Premium SEO Pack: Excellent', $this->the_plugin->localizationName )
			);
...
?>
			...
			<div class="psp-meta-box-container" style="display:none;">
				...
				<div class="psp-tab-menu">
					<a href="#dashboard" class="open"><?php _e('Dashboard', $this->the_plugin->localizationName);?></a>
					<a href="#page_meta"><?php _e('The Meta', $this->the_plugin->localizationName);?></a>
					<a href="#page_status"><?php _e('Page Status', $this->the_plugin->localizationName);?></a>
					<a href="#social_settings"><?php _e('Social Settings', $this->the_plugin->localizationName);?></a>
					<a href="#advance_seo"><?php _e('Advanced SEO', $this->the_plugin->localizationName);?></a>
				</div>
				...
				<div class="psp-tab-container">
					...
					<div id="psp-tab-div-id-dashboard" style="display:block;">
						<div class="psp-dashboard-box span_3_of_3" rel="psp-box-id-visits-and-serp">
							<h1><?php _e('SEO Status', $this->the_plugin->localizationName);?></h1>
							<div class="psp-dashboard-box-content">
								<table id="psp-seo-score-box" style="width:100%;">
									<tr>
										<td width="200">
											<h3><?php _e('Your Focus Keywords', $this->the_plugin->localizationName);?></h3>
										</td>
										<td valign="top">
											...
											<?php if( isset($focus_kw) && trim($focus_kw) != "" ) { ?>
												<a style="position: relative; bottom: -8px;" id="psp-edit-focus-keywords" class="psp-button blue" href="#edit-focus-keywords">
													<?php _e('Edit Focus Keywords', $this->the_plugin->localizationName);?>
												</a>
											<?php 
												}else{
											?>
												<a style="position: relative; bottom: 0px;" id="psp-edit-focus-keywords" class="psp-button blue" href="#edit-focus-keywords">
													<?php _e('Add Focus Keywords', $this->the_plugin->localizationName);?>
												</a>
											<?php
												}
											?>
											...
											<a style="position: relative; bottom: -8px; margin-left:5px;" id="psp-btn-metabox-autofocus2" class="psp-button blue" href="#btn-metabox-autofocus2">
												<?php _e('Auto-complete fields', $this->the_plugin->localizationName);?>
											</a>
											<?php } ?>
										</td>
									</tr>
									...
									<tr>
										<td>
											<h3><?php _e('Seo Score', $this->the_plugin->localizationName);?></h3>
										</td>
										<td valign="top">
									...
									<tr>
										<td>
											<h3><?php _e('Keyword Density', $this->the_plugin->localizationName);?></h3>
										</td>
										<td>
										<?php
										// density
									...
									<tr>
										<td valign="top">
											<h3 style="margin-top: 10px;"><?php _e('Summary Analytics', $this->the_plugin->localizationName);?></h3>
										</td>
										<td valign="top">
					...
					<div id="psp-tab-div-id-page_meta" style="display:none;">
						<div class="psp-dashboard-box span_3_of_3">
							<h1><?php _e('Page Meta', $this->the_plugin->localizationName);?></h1>
							<div class="psp-dashboard-box-content">
								<table class="form-table" id="psp-form-meta-tags">
									<tbody>
										<tr>
											<td valign="top">
												<?php _e('Snippet Preview:', $this->the_plugin->localizationName);?><br />
												<i style="font-size: 10px; color: #ccc;"><?php _e('Auto-Refresh each 2 seconds:', $this->the_plugin->localizationName);?></i>
											</td>
											<td>
												<div class="psp-prev-box">
													...
													<?php if ( !$parse_shortcodes ) { ?>
													<a style="margin-top:5px;" id="psp-btn-metabox-autofocus" class="psp-button blue" href="#metabox-autofocus"><?php _e('Auto-complete fields', $this->the_plugin->localizationName);?></a>
													<?php } ?>
												</div>
											</td>
										</tr>
										<tr>
											<td valign="top">
												<label for="psp-field-focuskw"><?php _e('Focus Keyword:', $this->the_plugin->localizationName);?></label>
											</td>
											<td>
										...
										<tr>
											<td valign="top">
												<label for="psp-field-title"><?php _e('SEO Title:', $this->the_plugin->localizationName);?></label>
											</td>
											<td>
												...
												<br>
												<p><?php _e('Title display in search engines is limited to 70 chars, <span id="psp-field-title-length"  class="psp-chars-left"></span> chars left.', $this->the_plugin->localizationName);?></p>
											</td>
										</tr>
										<tr>
											<td valign="top">
												<label for="psp-field-metadesc"><?php _e('Meta Description:', $this->the_plugin->localizationName);?></label>
											</td>
											<td>
												...
												<p><?php _e('The meta description will be limited to 160 chars, <span id="psp-field-metadesc-length"  class="psp-chars-left"></span> chars left.', $this->the_plugin->localizationName);?> </p>
											</td>
										</tr>
										<tr>
											<td valign="top">
												<label for="psp-field-metakeywords"><?php _e('Meta Keywords:', $this->the_plugin->localizationName);?></label>
											</td>
											<td>
												...
												<p><?php _e('The meta metakewords will be limited to 160 chars, <span id="psp-field-metakeywords-length" class="psp-chars-left"></span> chars left.', $this->the_plugin->localizationName);?> </p>
											</td>
										</tr>
									</tbody>
								</table>
					...
					<div id="psp-tab-div-id-social_settings" style="display:none;">
						<div class="psp-dashboard-box span_3_of_3">
						<h1><?php _e('Social settings', $this->the_plugin->localizationName);?></h1>
						<div class="psp-dashboard-box-content">
							<table class="form-table">
								<tbody>
									<tr>
										<td valign="top">
											<label for="psp-field-facebook-isactive"><?php _e('Use Facebook Meta:', $this->the_plugin->localizationName);?></label>
										</td>
										<td>
											<select name="psp-field-facebook-isactive" id="psp-field-facebook-isactive">
												<option value="default" <?php echo $fb_isactive=='default' ? 'selected="true"' : ''; ?> ><?php _e('Default settings', $this->the_plugin->localizationName);?></option>
												<option value="yes" <?php echo $fb_isactive=='yes' ? 'selected="true"' : ''; ?> ><?php _e('Yes', $this->the_plugin->localizationName);?></option>
												<option value="no" <?php echo $fb_isactive=='no' ? 'selected="true"' : ''; ?> ><?php _e('No', $this->the_plugin->localizationName);?></option>
											</select>
											<p><?php _e('Choose Yes if you want to use Facebook Meta Tags on your page', $this->the_plugin->localizationName);?></p>
										</td>
									</tr>
									<tr>
										<td valign="top">
											<label for="psp-field-facebook-titlu"><?php _e('Facebook Title:', $this->the_plugin->localizationName);?></label>
										</td>
										<td>
											...
											<p><?php _e('Add a custom title for your post. This will be used to post on an user\'s wall when they like/share this post on Facebook.', $this->the_plugin->localizationName);?></p>
										</td>
									</tr>
									<tr>
										<td valign="top">
											<label for="psp-field-facebook-desc"><?php _e('Facebook Description:', $this->the_plugin->localizationName);?></label>
										</td>
										<td>
											...
											<p><?php _e('Add a custom description for your post. This will be used to post on an user\'s wall when they share this post on Facebook.', $this->the_plugin->localizationName);?></p>
										</td>
									</tr>
									<?php if ( !$__istax ) { ?>
									<tr>
										<td valign="top">
											<label for="psp-field-facebook-image"><?php _e('Facebook Image:', $this->the_plugin->localizationName);?></label>
										</td>
										<td>
										<?php
										...
										?>
											<p><?php _e('Add a custom image for your post. This will be used to post on an user\'s wall when they share this post on Facebook.', $this->the_plugin->localizationName);?></p>
										</td>
									</tr>
									<?php } ?>
									<tr>
										<td valign="top">
											<label for="psp-field-facebook-opengraph-type"><?php _e('Open Graph Type:', $this->the_plugin->localizationName);?></label>
										</td>
										<td>
										<?php
										...
										?>
										<!--<p><?php _e('Choose Open Graph Type.', $this->the_plugin->localizationName);?></p>-->
										</td>
									</tr>
								</tbody>
							</table>
					...
					<div id="psp-tab-div-id-page_status" style="display:none;">
						<div class="psp-dashboard-box span_3_of_3">
							<h1><?php _e('Page Status', $this->the_plugin->localizationName);?></h1>
					...
					<div class="psp-dashboard-box span_3_of_3">
						<h1><?php _e('Advanced SEO', $this->the_plugin->localizationName);?></h1>
						<div class="psp-dashboard-box-content psp-seo-status-container">
							<table class="form-table">
								<tbody>
									<tr>
										<td valign="top">
											<label for="psp-field-meta_robots_index"><?php _e('Meta Robots Index:', $this->the_plugin->localizationName);?></label>
										</td>
										<td>
											<select name="psp-field-meta_robots_index" id="psp-field-meta_robots_index">
												<option value="default" <?php echo isset($psp_meta['robots_index']) && $psp_meta['robots_index']=='default' ? 'selected="true"' : ''; ?> ><?php _e('Default settings', $this->the_plugin->localizationName);?></option>
												<option value="index" <?php echo isset($psp_meta['robots_index']) && $psp_meta['robots_index']=='index' ? 'selected="true"' : ''; ?> ><?php _e('Index', $this->the_plugin->localizationName); ?></option>
												<option value="noindex" <?php echo isset($psp_meta['robots_index']) && $psp_meta['robots_index']=='noindex' ? 'selected="true"' : ''; ?> ><?php _e('NO Index', $this->the_plugin->localizationName); ?></option>
											</select>
											<p><?php _e('Tell robots not to index the content of a page.', $this->the_plugin->localizationName);?></p>
										</td>
									</tr>
									<tr>
										<td valign="top">
											<label for="psp-field-meta_robots_follow"><?php _e('Meta Robots Follow:', $this->the_plugin->localizationName);?></label>
										</td>
										<td>
											<select name="psp-field-meta_robots_follow" id="psp-field-meta_robots_follow">
												<option value="default" <?php echo isset($psp_meta['robots_follow']) && $psp_meta['robots_follow']=='default' ? 'selected="true"' : ''; ?> ><?php _e('Default settings', $this->the_plugin->localizationName);?></option>
												<option value="follow" <?php echo isset($psp_meta['robots_follow']) && $psp_meta['robots_follow']=='follow' ? 'selected="true"' : ''; ?> ><?php _e('Follow', $this->the_plugin->localizationName); ?></option>
												<option value="nofollow" <?php echo isset($psp_meta['robots_follow']) && $psp_meta['robots_follow']=='nofollow' ? 'selected="true"' : ''; ?> ><?php _e('NO Follow', $this->the_plugin->localizationName); ?></option>
											</select>
											<p><?php _e('Tell robots not to scan page for links to follow.', $this->the_plugin->localizationName);?></p>
										</td>
									</tr>
									<?php if ( !$__istax ) { ?>
									<tr>
										<td valign="top">
											<label for="psp-field-include-sitemap"><?php _e('Include in Sitemap:', $this->the_plugin->localizationName);?></label>
										</td>
										<td>
											<select name="psp-field-include-sitemap" id="psp-field-include-sitemap">
												<option value="default" <?php echo $psp_sitemap_isincluded=='default' ? 'selected="true"' : ''; ?> ><?php _e('Default settings', $this->the_plugin->localizationName);?></option>
												<option value="always_include" <?php echo $psp_sitemap_isincluded=='always_include' ? 'selected="true"' : ''; ?> ><?php _e('Always include', $this->the_plugin->localizationName);?></option>
												<option value="never_include" <?php echo $psp_sitemap_isincluded=='never_include' ? 'selected="true"' : ''; ?> ><?php _e('Never include', $this->the_plugin->localizationName);?></option>
											</select>
											<p><?php _e('Should this page be in the XML Sitemap?', $this->the_plugin->localizationName);?></p>
										</td>
									</tr>
									<tr>
										<td valign="top">
											<label for="psp-field-priority-sitemap"><?php _e('Sitemap Priority:', $this->the_plugin->localizationName);?></label>
										</td>
										<td>
											<select name="psp-field-priority-sitemap" id="psp-field-priority-sitemap">
												<option value="-" <?php echo isset($psp_meta['priority']) && in_array($psp_meta['priority'], array('', '-')) ? 'selected="true"' : ''; ?> ><?php _e('Automatic', $this->the_plugin->localizationName);?></option>
												<?php
									...
									<tr>
										<td valign="top">
											<label for="psp-field-canonical"><?php _e('Canonical url:', $this->the_plugin->localizationName);?></label>
										</td>
										<td>
											...
											<p><?php _e('A canonical page is the preferred version of a set of pages with highly similar content.', $this->the_plugin->localizationName);?></p>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<tbody>
					<tr class="form-field">
						<th valign="top" scope="row">
							<?php echo __('SEO Settings', $this->the_plugin->localizationName);?>
						</th>
						<td>
			<?php
			echo '
